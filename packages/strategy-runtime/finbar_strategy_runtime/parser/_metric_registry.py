...
METRICS: list[MarketMetricDefinition] = [
    ...
    # --- Proxy OHLCV approximations (12 metrics, all under MetricFamily.PROXY).
    # Each is a real dispatched handler in inside_bar.py; the ATR-cluster
    # (proxy_atr + 4 dependents) shares computation via the per-call cache.
    MarketMetricDefinition(
        name="proxy_atr",
