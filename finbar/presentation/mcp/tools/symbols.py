...
def _usage_guide_text() -> str:
    return (
        ...
        "    8. get_backtest_trades(result_id, page, page_size) and "
        "get_backtest_equity(result_id, mode) fetch details only when needed.\n"
        "    9. save_strategy_json(definition) → persist\n\n"
        ...
        "    7. Use get_backtest_trades / get_backtest_equity for "
        "large details on demand.\n\n"
