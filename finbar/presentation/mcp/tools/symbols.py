...
def _usage_guide_text() -> str:
    return (
        ...
        " max_bars=500) → bars (most recent N by default)\n"
        ...
        "  NOTE: get_cached_prices returns max 500 bars by default. Use "
        "start_date/end_date or higher max_bars to get more.\n\n"
        "INDICATORS\n"
